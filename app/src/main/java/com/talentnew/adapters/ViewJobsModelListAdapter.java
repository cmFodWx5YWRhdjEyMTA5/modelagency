...
public class ViewJobsModelListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public ViewJobsModelListAdapter(Context context, List<MyModel> itemList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        switch (viewType){
            case 0:
                View v0 = inflater.inflate(R.layout.view_jobs_model_list_item_layout, parent, false);
                viewHolder = new MyModelsListViewHolder(v0);
                break;
            default:
                View v = inflater.inflate(R.layout.view_jobs_model_list_item_layout, parent, false);

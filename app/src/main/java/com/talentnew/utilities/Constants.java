...
public class Constants {
 ...
 public static String SUBSC_BOOST_ID="boostId";
 public static String SUBSC_JOB_POST="jobPost";
 public static String SUBSC_EMIL_SHOUTOUT="emailShoutOut";
 public static String SUBSC_FB_SHOUTOUT="fbShoutOut";
 public static String SUBSC_BOOSTJOB="boostJob";
 public static String SUBSC_CUSTOMADD="customAdd";
 public static String SUBSC_TITLE="title";
 public static String SUBSC_DEDICATED_MANAGER="dedicatedManager";
 public static String SUBSC_CONTACT_MODEL="contactModel";
 public static String SUBSC_PRO_TAG="proTag";
 public static String SUBSC_VERIFIED_TAG="verifiedTag";
 public static String SUBSC_VALIDITY="validity";
 public static String SUBSC_SCHEME="scheme";
 public static String SUBSC_AMOUNT="amount";
